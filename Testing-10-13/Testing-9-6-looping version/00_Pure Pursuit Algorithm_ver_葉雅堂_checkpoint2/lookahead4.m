function [lookheading_point, closest_index,lookingahead_vel] = lookahead4(velocity, current_Position, givenpath,DT)
...
lookingahead_vel = 0; %not sett'ed yet. intial speed != 0, and can be replacable. 這樣getnextstate才能過
end
