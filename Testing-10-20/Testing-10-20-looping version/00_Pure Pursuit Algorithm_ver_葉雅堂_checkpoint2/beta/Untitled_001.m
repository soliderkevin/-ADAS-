...
display = HelperTrackingAndPlanningDisplay;   % just plot
...
while advance(scenario)
    ...
    for i = 1:numel(timesteps)
        predictedTracks(:,i+1) = predictTracksToTime(tracker,'confirmed',timesteps(i)); % matlab  function
    end
    ...
    helperMoveEgoToState(egoVehicle,egoState); %更新本車速度位置與航向角
